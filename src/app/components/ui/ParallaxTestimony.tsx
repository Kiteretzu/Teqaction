...
export default function DarkTestimonials() {
  ...
  return (
    <section
      ...
      className="relative min-h-screen bg-gradient-to-br from-black via-gray-900 to-slate-900 overflow-hidden py-20"
    >
      {/* Aurora Effect */}
        ...
        >
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <p className="text-lg text-gray-300">
              Ready to join the ranks of digital overlords?
            </p>
